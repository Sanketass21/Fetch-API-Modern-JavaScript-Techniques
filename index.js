...
// function getData gets the data from the api and then give that data to the showData function as argument
...
// showData function display the data which came from the api .
